...
#price_curve = "HPFC_AT_2023_09_28_2023_2024.xlsx"
price_curve = "HPFC_AT_2025-2028_26_02_2024.xlsx"

add_to_title = "Walter_Koralpe_20240226_001_45MW"
if add_to_title != "":
...
# Koralpe_24_25_empty
for condition in ["default"]: #["default',"orig", "orig_oct","Jan","Feb","Mar","Apr"]:
    title = create_dir_name(starttime, endtime)
