...
#topology = "Kamering"
#topology = "Fragant"
#topology = "Fragant_big"
#topology = "Goessnitz"
topology = "Forstsee_no_pump"
...
price_curve = "Forwardcurve_AT_2026-2028.xlsx"


add_to_title = "Harald_FOR_2026-2028_Budget_001"
if add_to_title != "":
    add_to_title = "_"+add_to_title

starttime = pd.Timestamp(2026,1,1)
endtime = pd.Timestamp(2029,1,1)
...
for condition in ["default"]: #["default',"orig", "simple"]:
    ...
    #special_condition = "Koralpe_25_revision_" + condition
    ...
    special_condition = "Forstsee_" + condition
