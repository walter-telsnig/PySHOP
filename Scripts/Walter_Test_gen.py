...
#topology = "Kegele_Brettsee_Zirmsee_3"
topology = "Koralpe_full"

price_curve = "HPFC_AT_2024_05_09_2024_2025.xlsx"

add_to_title = "Walter_Test_20230907_PSKW_Koralpe_001"
if add_to_title != "":
...
for condition in ["default"]: #["default',"orig", "simple"]:
    title = create_dir_name(starttime, endtime)
    special_condition = "Koralpe_24_25_" + condition
