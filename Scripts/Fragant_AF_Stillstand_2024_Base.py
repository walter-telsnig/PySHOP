...
file_path_root, file_path_detail = set_path("/Bewertung/Stillstand_AF/specific/"+ create_date_string(starttime) + "/" + topology)
...
#shop.model.generator.AF_G1.maintenance_flag.set(1)
shop.model.generator.AF_G1.maintenance_flag.set(pd.Series([0,1,0], index=[starttime, pd.Timestamp(2024,9,9), pd.Timestamp(2024,12,16)]))
